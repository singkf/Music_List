...
//创建一个意图对象，是从当前的 Activity 跳转到 Service
...
//这一行注解是保证 API 在 KITKAT 以上的模拟器才能顺利运行，也就是 19 以上
...
//获取当前进度 currentPosition 和总时长 duration
